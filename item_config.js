...
export function getItemConfig(itemTypeId, itemName) {
    ...
    // 合并配置（特定配置覆盖默认配置）
    return Object.assign(Object.assign(Object.assign({}, defaultConfig), nameConfig), { placement: Object.assign(Object.assign({}, defaultConfig.placement), (nameConfig.placement || {})) });
}
/**
 * 获取模型变体编号
...
// export const noGravityConfig = {};
// export const hitboxConfig = {};
// export const placementConfig = {};
// // 从统一配置生成旧格式的配置（用于向后兼容）
// for (const [itemTypeId, configs] of Object.entries(itemConfig)) {
//   // 生成 variantConfig
//   variantConfig[itemTypeId] = {};
//   noGravityConfig[itemTypeId] = [];
//   hitboxConfig[itemTypeId] = {};
//   placementConfig[itemTypeId] = configs["_default"]?.placement || {
//     wall: 0.3,
//     ground: 1.01,
//     ceiling: -0.01
//   };
...
//       variantConfig[itemTypeId][name] = config.variant;
//     }
//     // noGravity
//     if (config.noGravity === true) {
//       noGravityConfig[itemTypeId].push(name);
//     }
//     // hitbox
//     if (config.hitbox) {
//       hitboxConfig[itemTypeId][name] = config.hitbox;
//     }
//   }
// }
//# sourceMappingURL=item_config.js.map